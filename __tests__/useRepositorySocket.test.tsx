...
import type { DocumentRemoved, DocumentState, DocumentUpdate } from '@ttab/elephant-api/repositorysocket'
...
describe('useRepositorySocket', () => {
  ...
  it('fetches documents, pushes updates, and cleans up on unmount', async () => {
    ...
    await waitFor(() => {
      // FIXME: What's this? DoumentState or DocumentStateWithIncludes? Probably DocumentBatch(WithIncludes)?
      const first = result.current.data[0] as DocumentState & { setName?: string }
