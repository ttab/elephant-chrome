...
import { toGroupedNewsDoc, group } from '../../shared/transformations/groupedNewsDoc.js'
...
import type { DeliverableType } from '../../src/defaults/templates/lib/getDeliverableType.js'

//
// TODO: This is a copy of src/lib/createYItem.ts. These should both be migrated to /shared
//
