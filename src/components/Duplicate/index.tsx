...
import { ToastAction } from '../QuickDocument/ToastAction'
            ...
            if (provider && status === 'authenticated' && duplicateId && session && repository) {
              try {
                ...
                toast.success(createTexts(granularity).success, {
                  action: <ToastAction planningId={type === 'Planning' ? duplicateId : undefined} eventId={type === 'Event' ? duplicateId : undefined} view={type} />
                })
              } catch (error) {
