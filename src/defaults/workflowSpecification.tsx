...
const baseDeliverable: WorkflowSpecification = {
  draft: {
    title: i18n.t('workflows:base.draft.title'),
    description: i18n.t('workflows:base.draft.description'),
    isWorkflow: true,
    requireCause: true,
    transitions: {
      done: {
        ...
        description: i18n.t('workflows:base.draft.transitions.done.description')
      },
      approved: {
        verify: true,
        title: i18n.t('workflows:base.draft.transitions.approved.title'),
        description: i18n.t('workflows:base.draft.transitions.approved.description')
      },
      usable: {
        verify: true,
        title: i18n.t('workflows:base.draft.transitions.usable.title'),
        description: i18n.t('workflows:base.draft.transitions.usable.description')
      },
      withheld: {
        verify: true,
    ...
    requireCause: true,
    description: i18n.t('workflows:base.done.description'),
    isWorkflow: true,
    transitions: {
      approved: {
        default: true,
        ...
        description: i18n.t('workflows:base.done.transitions.approved.description')
      },
      usable: {
        verify: true,
        title: i18n.t('workflows:base.done.transitions.usable.title'),
        description: i18n.t('workflows:base.done.transitions.usable.description')
      },
      withheld: {
        verify: true,
      ...
      draft: {
        ...
        description: i18n.t('workflows:base.done.transitions.draft.description')
      },
      unpublished: {
        verify: true,
        title: i18n.t('workflows:base.done.transitions.unpublished.title'),
        description: i18n.t('workflows:base.done.transitions.unpublished.description')
      }
    }
  },
  approved: {
    title: i18n.t('workflows:base.approved.title'),
    description: i18n.t('workflows:base.approved.description'),
    isWorkflow: true,
    requireCause: true,
    transitions: {
      usable: {
        ...
        description: i18n.t('workflows:base.approved.transitions.usable.description')
      },
      withheld: {
        verify: true,
      ...
      draft: {
        ...
        description: i18n.t('workflows:base.approved.transitions.draft.description')
      },
      unpublished: {
        verify: true,
        title: i18n.t('workflows:base.approved.transitions.unpublished.title'),
        description: i18n.t('workflows:base.approved.transitions.unpublished.description')
      }
    }
  },
  usable: {
    title: i18n.t('workflows:base.usable.title'),
    description: i18n.t('workflows:base.usable.description'),
    isWorkflow: true,
    requireCause: true,
    transitions: {
      draft: {
        ...
        description: i18n.t('workflows:base.usable.transitions.draft.description')
      },
      unpublished: {
        verify: true,
        title: i18n.t('workflows:base.usable.transitions.unpublished.title'),
        description: i18n.t('workflows:base.usable.transitions.unpublished.description')
      }
    }
  },
  withheld: {
    title: i18n.t('workflows:base.withheld.title'),
    description: i18n.t('workflows:base.withheld.description'),
    isWorkflow: true,
    requireCause: true,
    transitions: {
      usable: {
        ...
        description: i18n.t('workflows:base.withheld.transitions.usable.description')
      },
      draft: {
        verify: true,
  ...
  unpublished: {
    ...
    description: i18n.t('workflows:base.unpublished.description'),
    isWorkflow: true,
    requireCause: true,
    transitions: {
      draft: {
        ...
        description: i18n.t('workflows:base.unpublished.transitions.draft.description')
      }
    }
  }
}
