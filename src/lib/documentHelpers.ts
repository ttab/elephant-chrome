 ...
 */
export function getSection(deliverable: ApprovalItem['deliverable']): string | undefined {
 ...
 */
export function getNewsvalue(deliverable: ApprovalItem['deliverable']): string | undefined {
