...
export type CalendarSearchIndexResult = SearchIndexResult
export type CalendarSearchIndexResponse = SearchIndexError | SearchIndexResult
 ...
 */
export async function searchIndex(search: object, options: SearchIndexOptions, skip?: number, size?: number): Promise<CalendarSearchIndexResponse> {
