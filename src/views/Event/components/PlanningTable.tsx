...
export const PlanningTable = ({ eventId, eventTitle }: {
  ...
  // Update plannings if update event is received for current documents
    ...
    : (
      <div className='flex flex-col gap-2 pt-4'>
        <div className='flex flex-start pb-2'>
          <CreateDocumentDialog type='Planning' payload={{ eventId, eventTitle, createdDocumentIdRef, mutator }}>
            <a
              href='#'
