...
import { type Events as EventsType } from '@/views/Overviews/EventsOverview/EventsTable/data/schema'
    ...
    <div>
      ...
      <div className="border-r h-full flex flex-col p-4 gap-8">
        {items.map(item => {
          ...
          const id = item._id
          const sector = EventsSectors.find((sector) => sector.value === item._source['document.rel.story.uuid'][0])
