  ...
  return (
    <div className="flex flex-row flex-auto justify-center">
      <form onSubmit={(e) => { e.preventDefault() }} className="self-center flex flex-col gap-4">
        <div>
          <input
            className="p-2 w-64 text-sm border border-gray-200 shadow rounded"
        ...
        <div>
          <button
            className="p-2 w-64 text-sm border border-gray-300 text-bold center bg-gray-100 shadow rounded"
            onClick={(e) => {
              e.preventDefault()
              if (!endpoint) {
                return
